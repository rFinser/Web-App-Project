...
$(document).on('click', '#addRatingBtn', function() {
    const restaurantDiv = $(this).parent();
    ...
    if (isRatingOpen) {
        ...
        sendRating(restaurantName, rating);
...
$(document).on('click', '.cancelRating', function() {
